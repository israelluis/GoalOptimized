function[MC_parameter,E_rate,w_rate,h_rate]= MC_BH04_R_published(muscle_parameter,muscle_DynCon,option,basalOn)
% read inputs
...
% decay_function = ones(data_length,1); % this is for antoine implementation
...
% l_M(:)=lMtilde; % this is for antoine implementation
M_s=  74; % w/kg 
M_f= 111; % w/kg
