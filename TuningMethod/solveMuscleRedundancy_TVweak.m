function [Results,DatStore,Misc] = solveMuscleRedundancy_TVweak(Misc)
% -----------------------------------------------------------------------%
% INPUTS:
...
for trial = 1:Misc.nTrials
    ...
    for k=1:N
        ...
        [Hilldiffk,FTk] = ForceEquilibrium_lMtildeState_optPassive_weak(ak,lMtildek,vMtildek,lM_projectedk,...
